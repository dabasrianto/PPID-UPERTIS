...
func initDB() {
	...
	_, _ = db.ExecContext(context.Background(), `
		...
		(
			...
			'informasi-publik-berkala', 
			'<h2>Informasi Publik Berkala</h2><p>Informasi berkala adalah informasi yang wajib disediakan dan diumumkan secara berkala oleh PPID Universitas Perintis Indonesia sekurang-kurangnya 6 bulan sekali.</p><h3>Daftar Informasi Publik Berkala</h3><ul><li><strong>Profil Universitas Perintis Indonesia:</strong> Kedudukan, domisili, alamat lengkap, visi, misi, fungsi, tugas, dan struktur organisasi.</li><li><strong>Ringkasan Laporan Keuangan:</strong> Laporan realisasi anggaran, neraca keuangan, dan laporan arus kas tahunan.</li><li><strong>Ringkasan Laporan Kinerja:</strong> Capaian kinerja tahunan universitas dan program studi.</li><li><strong>Peraturan & Kebijakan Rektor:</strong> Regulasi akademik, kemahasiswaan, dan tata kelola universitas.</li></ul>', 
			true, 1
		),
		(
			...
			'informasi-tersedia-setiap-saat', 
			'<h2>Informasi Tersedia Setiap Saat</h2><p>Informasi yang wajib tersedia setiap saat adalah informasi publik yang harus disediakan oleh PPID Universitas Perintis Indonesia dan siap diberikan kepada pemohon informasi saat dibutuhkan.</p><h3>Daftar Informasi Tersedia Setiap Saat</h3><ul><li><strong>Daftar Informasi Publik (DIP):</strong> Rekapitulasi daftar dokumen publik yang dikelola oleh PPID.</li><li><strong>Rencana Strategis (Renstra) & Rencana Kerja:</strong> Dokumen perencanaan pembangunan jangka menengah dan program kerja tahunan.</li><li><strong>Statuta Universitas:</strong> Anggaran dasar dan landasan penyelenggaraan pendidikan di UPERTIS.</li><li><strong>Panduan Pelayanan Informasi:</strong> SOP permohonan informasi, keberatan, serta prosedur pengaduan.</li></ul>', 
			true, 2
		),
		(
			...
			'info-serta-merta', 
			'<h2>Informasi Serta Merta</h2><p>Informasi serta merta adalah informasi publik yang dapat mengancam hajat hidup orang banyak dan ketertiban umum, yang wajib diumumkan secara serta merta tanpa penundaan.</p><h3>Daftar Informasi Serta Merta</h3><ul><li><strong>Sistem Peringatan Dini Bencana:</strong> Prosedur evakuasi, nomor kontak darurat kampus, dan panduan keselamatan.</li><li><strong>Informasi Kesehatan & Keselamatan Kerja (K3):</strong> Panduan penanggulangan wabah penyakit, kebakaran, dan situasi medis darurat di lingkungan kampus.</li><li><strong>Pengumuman Darurat:</strong> Penyesuaian kegiatan akademik atau operasional kampus akibat keadaan kahar (force majeure).</li></ul>', 
			true, 3
		),
		(
			'Zona Integrasi (ZI)', 
			...
			'zona-integrasi', 
			'<h2>Zona Integrasi (ZI)</h2><p>Pembangunan Zona Integrasi di lingkungan Universitas Perintis Indonesia merupakan langkah nyata dalam reformasi birokrasi guna mewujudkan pelayanan publik yang prima, bersih, akuntabel, dan bebas dari korupsi.</p><h3>Fokus Area Pembangunan Zona Integrasi</h3><ul><li><strong>Manajemen Perubahan:</strong> Mengubah sistem kerja, pola pikir, dan budaya kerja organisasi.</li><li><strong>Penataan Tata Laksana:</strong> Meningkatkan efisiensi sistem kerja melalui digitalisasi (e-office, e-learning, dll).</li><li><strong>Penataan Sistem Manajemen SDM:</strong> Transparansi rekrutmen, penilaian kinerja berbasis merit, dan pengembangan kompetensi.</li><li><strong>Penguatan Pengawasan:</strong> Pencegahan korupsi, gratifikasi, serta integrasi sistem penanganan pengaduan (Whistleblowing System).</li></ul>', 
			true, 4
		),
		(
